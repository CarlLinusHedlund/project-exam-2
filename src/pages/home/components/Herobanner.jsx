  ...
  return (
    <>
      <motion.h1
        ...
        className=" text-[42px] sm:text-[55px] lg:text-[75px] font-extrabold leading-[3rem] sm:leading-[4rem] md:leading-[5rem]  "
      >
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        <div className=" text-[20px] xxs:text-[25px]  md:text-[30px] font-semibold ">
      ...
      <div className="flex gap-5 md:pt-32">
        <div className="flex flex-col gap-5 w-1/2 items-end justify-between ">
          <motion.img
            ...
            className=" w-full max-w-[250px] object-cover h-[200px] rounded-[10px] "
          ...
          <motion.img
            ...
            initial={{ y: 50 }}
            animate={{ y: 0, transition: { duration: 0.5 } }}
            className=" w-[70%] h-[150px] object-cover rounded-[10px] "
        ...
        <div className="flex gap-5 w-1/2 justify-start ">
          <img
            className="w-1/2 md:w-full -translate-y-20 max-w-[250px] h-[340px] rounded-[10px] object-cover"
